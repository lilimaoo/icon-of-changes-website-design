...
function initLikeButton() {
  ...
  // Set initial state
  let count =
    parseInt(localStorage.getItem(`article_${articleId}_like_count`)) ||
...
function initCommentSystem() {
  ...
  let comments =
    JSON.parse(localStorage.getItem(`article_${articleId}_comments`)) || [];

  // If no comments in storage, add some dummy ones
  if (comments.length === 0) {
    comments = generateDummyComments();
    localStorage.setItem(
      `article_${articleId}_comments`,
  ...
  commentsContainer.addEventListener("click", function (e) {
    ...
    if (e.target.classList.contains("reply-submit")) {
      ...
      const commentId = parseInt(
        e.target.closest(".reply-form").dataset.commentId
      );
      const nameInput = e.target
        .closest(".reply-form")
        .querySelector(".reply-name");
      ...
      // Refresh the display
      displayComments(
        comments.slice(0, document.querySelectorAll(".comment-item").length)
      );
...
function createCommentElement(comment) {
  ...
  commentElement.innerHTML = `
        <div class="comment-header">
            <div class="comment-avatar">${comment.name
              .charAt(0)
              .toUpperCase()}</div>
        ...
        <div class="reply-form" data-comment-id="${
          comment.id
        }" style="display: none;">
  ...
  if (comment.replies && comment.replies.length > 0) {
    ...
    comment.replies.forEach((reply) => {
      ...
      replyElement.innerHTML = `
                <div class="comment-header">
                    <div class="comment-avatar">${reply.name
                      .charAt(0)
                      .toUpperCase()}</div>
                    <div class="comment-meta">
  ...
  return [
    {
      ...
      content:
        "This is a fantastic initiative! I'm inspired by the work you're doing and would love to get involved somehow.",
      ...
      replies: [
        {
          ...
          name: "Maria Santos",
          content:
            "Thank you John! We'd love to have you on board. You can check out our volunteer page for opportunities.",
    ...
    },
    {
      ...
      content:
        "I participated in last year's event and it was life-changing. The impact these programs have on communities is truly remarkable.",
    ...
    },
    {
      ...
      content:
        "Is there a way to support this initiative financially? I'd love to contribute to your mission.",
      ...
      replies: [
        {
          ...
          name: "Admin",
          content:
            "Hi Michael, thank you for your interest! Yes, you can donate through our website's donation page, or contact us directly for other ways to support.",
    ...
    },
    {
      ...
      content:
        "I'm a teacher at a local school and would love to bring these programs to our students. Do you offer educational workshops?",
